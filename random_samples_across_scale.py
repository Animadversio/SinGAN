...
opt = parser.parse_args(['--mode', "random_samples", "--input_name", "starry_night.png", '--scale_h', "1", '--gen_start_scale', '1', '--scale_factor', '0.75'])
opt = functions.post_config(opt)
#%%
opt = parser.parse_args(['--mode', "random_samples", "--input_name", "mountains.jpg", '--scale_h', "1", '--gen_start_scale', '1', '--scale_factor', '0.75'])
opt = functions.post_config(opt)
dirlab = ",sf_0.75"
